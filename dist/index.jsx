...
var useAlert = function () {
    ...
    var useContent = function (key, _a) {
        ...
        <material_1.Box sx={__assign(__assign({}, colors), { wordBreak: "break-word", display: "flex", alignItems: "center", p: p })} key={key}>
        <Icon sx={{ mr: p }}/>
        <material_1.Typography variant="body2" sx={{ mr: "auto" }}>
          {message}
        </material_1.Typography>
        <material_1.IconButton onClick={function () { return closeSnackbar(key); }} color="inherit">
...
var AlertProvider = function (_a) {
    ...
    return (<notistack_1.SnackbarProvider TransitionComponent={material_1.Collapse} classes={{
